package com.kish.eshop.inventory.service.impl;
...
import com.kish.eshop.inventory.mapper.ProductInventoryMapper;
import com.kish.eshop.inventory.model.ProductInventory;
import com.kish.eshop.inventory.service.ProductInventoryService;
...
public class ProductInventoryServiceImpl implements ProductInventoryService {
	...
	public ProductInventory findByProductId(Long productId) {
		...
		if(dataJSON!=null&&!"".equals(dataJSON)){
			...
			return JSONObject.parseObject(dataJSONObject.toString(),ProductInventory.class);
		}else{
